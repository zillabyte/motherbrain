package grandmotherbrain.coordination.mock;

import grandmotherbrain.coordination.AskHandler;
import grandmotherbrain.coordination.AskWrapper;
...
//    clear();
  ...
  @Override
  public grandmotherbrain.coordination.Lock lock(final String name, long timeout, long duration) {
...
//    _log.info("lock success: " + name);
    ...
    return(new grandmotherbrain.coordination.Lock() {
      @Override
